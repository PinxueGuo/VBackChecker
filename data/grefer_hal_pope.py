...
class G_REFER_HAL_POPE:
    def __init__(self, data_root, dataset="grefcoco_hal_pope", splitBy="unc"):
        # provide data_root folder which contains grefcoco
        print("loading dataset %s into memory..." % dataset)
        self.ROOT_DIR = osp.abspath(osp.dirname(__file__))
        self.DATA_DIR = osp.join(data_root, dataset)
        if dataset in ["grefcoco_hal_pope"]:
            self.IMAGE_DIR = "/home/ubuntu/researches/lisa_datasets/refer_seg/grefcoco_hal_pope/images"
        else:
